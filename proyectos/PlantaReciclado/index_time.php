...
<body>
 ...
 <table>
  <tr>
    <th>
		<a href="http://www.subtilis.com.ar/stl/index.html">
			<img src="icons/stl.png" alt="STL Energias Renovables" border=0 width="100px" height="100px"/>
		</a>	
	</th>
        <th></th>
...
<form method="post">
	<center><table>
		<tr>
			<th><a <center><input type="datetime-local" name="fecha_desde"/></center></a></th>
			<th><a <center><input type="datetime-local" name="fecha_hasta" /></center></a></th>
			<th><a <center><input type="submit" value="Graficar"/></center></a></th>
		</tr>
	</table></center>
 ...
 <!--<table>
  <tr>
	...
	<th><a href="../stl/index.html"><center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Inicio&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</center></a></th>
	...
	<th><a <center><input type="datetime-local" /></center></a></th>
	<th><a <center><input type="datetime-local" /></center></a></th>
  </tr>
</table> --> 
</center>
...
<?php
	...
	$q="select Amps, t_P1, fechahora from planta_reciclado WHERE fechahora BETWEEN DATE_FORMAT('$fecha_desde', '%Y-%m-%dT%H:%i') AND DATE_FORMAT('$fecha_hasta', '%Y-%m-%dT%H:%i')  ";	
